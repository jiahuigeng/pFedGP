...
parser.add_argument("--num-client-agg", type=int, default=3, help="number of kernels")
...
parser.add_argument("--mini", type=bool, default=False, help="if use smaller scale dataset")
...
if args.data_name in ['cifar10', 'cifar100', 'cinic10'] or args.input_size == 32:
...
for data in args.data_name:
    GPs.append(pFedGPFullLearner(args, classes_per_client[data]))
